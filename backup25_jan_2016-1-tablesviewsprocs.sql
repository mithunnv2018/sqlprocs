...
/*Table structure for table `tbl_sotblacklist_complaints` */

DROP TABLE IF EXISTS `tbl_sotblacklist_complaints`;

CREATE TABLE `tbl_sotblacklist_complaints` (
  `sotblacklist_id` varchar(50) NOT NULL,
  `sotblacklist_companyname` varchar(500) DEFAULT NULL,
  `sotblacklist_companydescription` longtext,
  `sotblacklist_companyaddress` longtext,
  `ofcmembers_id_sotblacklist` varchar(50) DEFAULT NULL,
  `sotindustrytype_id_sotblacklist` varchar(50) DEFAULT NULL,
  `city_id_sotblacklist` varchar(50) DEFAULT NULL,
  `sotblacklist_reasontitle` varchar(500) DEFAULT NULL,
  `sotblacklist_reasondescription` longtext,
  `sotblacklist_myphonenos` varchar(500) DEFAULT NULL,
  `sotblacklist_myemailid` varchar(1000) DEFAULT NULL,
  `sotblacklist_isverified` varchar(50) DEFAULT 'no',
  `sotblacklist_isblacklisted` varchar(50) DEFAULT 'no',
  `sotblacklist_rating` int(11) DEFAULT '5',
  `createdate` datetime DEFAULT NULL,
  `modifieddate` datetime DEFAULT NULL,
  `status` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`sotblacklist_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `tbl_sotblacklist_complaints` */

insert  into `tbl_sotblacklist_complaints`(`sotblacklist_id`,`sotblacklist_companyname`,`sotblacklist_companydescription`,`sotblacklist_companyaddress`,`ofcmembers_id_sotblacklist`,`sotindustrytype_id_sotblacklist`,`city_id_sotblacklist`,`sotblacklist_reasontitle`,`sotblacklist_reasondescription`,`sotblacklist_myphonenos`,`sotblacklist_myemailid`,`sotblacklist_isverified`,`sotblacklist_isblacklisted`,`sotblacklist_rating`,`createdate`,`modifieddate`,`status`) values ('1','1','1',NULL,'1','1','1',NULL,NULL,NULL,NULL,'no','no',5,NULL,NULL,'active');

/*Table structure for table `tbl_sotindustrytype_master` */

DROP TABLE IF EXISTS `tbl_sotindustrytype_master`;

CREATE TABLE `tbl_sotindustrytype_master` (
  `sotindustrytype_id` varchar(50) NOT NULL,
  `sotindustrytype_name` varchar(500) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `modifieddate` datetime DEFAULT NULL,
  `status` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`sotindustrytype_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `tbl_sotindustrytype_master` */

insert  into `tbl_sotindustrytype_master`(`sotindustrytype_id`,`sotindustrytype_name`,`createdate`,`modifieddate`,`status`) values ('1','IT',NULL,NULL,'active'),('2','Chemical ',NULL,NULL,'active'),('3','Pharma',NULL,NULL,'active');
