...
/*Table structure for table `tbl_ofcmemplan_details` */

DROP TABLE IF EXISTS `tbl_ofcmemplan_details`;

CREATE TABLE `tbl_ofcmemplan_details` (
  `ofcmemplan_id` varchar(50) NOT NULL,
  `ofcmembers_id_ofcmemplan` varchar(50) NOT NULL,
  `plan_id_ofcmemplan` varchar(50) DEFAULT NULL,
  `ofcmemplan_startdate` datetime DEFAULT NULL,
  `ofcmemplan_enddate` datetime DEFAULT NULL,
  `ofcmemplan_status` varchar(50) DEFAULT NULL,
  `ofcmemplan_coupon` varchar(100) DEFAULT NULL,
  `ofcmemplan_discount` decimal(10,0) DEFAULT NULL,
  `ofcmemplan_rate` decimal(10,0) DEFAULT NULL,
  `ofcmemplan_currency` varchar(50) DEFAULT NULL,
  `ofcmemplan_coinsassigned` int(11) DEFAULT NULL,
  `ofcmemplan_jobfees` decimal(10,0) DEFAULT NULL,
  `ofcmemplan_nosofteammembers` int(11) DEFAULT NULL,
  `ofcmemplan_description` longtext,
  `ofcmemplan_paymentmethod` varchar(100) DEFAULT 'debitcard' COMMENT 'creditcard/debitcard/netbanking',
  `ofcmemplan_ispaid` varchar(50) DEFAULT 'yes',
  `createdate` datetime DEFAULT NULL,
  `modifieddate` datetime DEFAULT NULL,
  `status` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`ofcmemplan_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `tbl_ofcmemplanconsume_details` */

DROP TABLE IF EXISTS `tbl_ofcmemplanconsume_details`;

CREATE TABLE `tbl_ofcmemplanconsume_details` (
  `ofcmemplanconsume_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ofcmemplan_id_ofcmemplanconsume` varchar(50) NOT NULL,
  `ofcsubmitproposal_id_ofcmemplanconsume` varchar(50) DEFAULT NULL,
  `ofcmemplanconsume_type` varchar(50) DEFAULT 'submitted' COMMENT 'post/submit',
  `ofcmemplanconsume_coins` decimal(10,0) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `modifieddate` datetime DEFAULT NULL,
  `status` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`ofcmemplanconsume_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Table structure for table `tbl_plan_master` */

DROP TABLE IF EXISTS `tbl_plan_master`;
...
CREATE TABLE `tbl_plan_master` (
  ...
  `plan_rate` decimal(10,0) DEFAULT NULL,
  `createdate` datetime DEFAULT NULL,
  `modifieddate` datetime DEFAULT NULL,
  `status` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`plan_id`)
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 IF @memid IS NULL AND @memid = '' THEN
			...
			LEAVE label1;
		 ELSE
			set sumcoins= (select sum(ofcmemplanconsume_coins) from tbl_ofcmemplanconsume_details a,tbl_ofcmemplan_details where a.ofcmemplan_id_ofcmemplanconsume=b.ofcmemplan_id and b.ofcmembers_id_ofcmemplan=@memid);
			-- CALL proc_common_select_single_json('vw_ofcmember_plan_details',concat('ofcmembers_id_ofcmemplan=\'',@memid,'\' ofcmemplan_status=\'active\''),outparam);
...
/*Table structure for table `vw_ofcmember_plan_details` */

DROP TABLE IF EXISTS `vw_ofcmember_plan_details`;

/*!50001 DROP VIEW IF EXISTS `vw_ofcmember_plan_details` */;
/*!50001 DROP TABLE IF EXISTS `vw_ofcmember_plan_details` */;

/*!50001 CREATE TABLE  `vw_ofcmember_plan_details`(
 `ofcmemplan_id` varchar(50) ,
 `ofcmembers_id_ofcmemplan` varchar(50) ,
 `ofcmemplan_startdate` datetime ,
 `ofcmemplan_enddate` datetime ,
 `ofcmemplan_status` varchar(50) ,
 `ofcmemplan_rate` decimal(10,0) ,
 `ofcmemplan_currency` varchar(50) ,
 `ofcmemplan_coinsassigned` int(11) ,
 `ofcmemplan_jobfees` decimal(10,0) ,
 `ofcmemplan_nosofteammembers` int(11) ,
 `ofcmemplan_description` longtext ,
 `createdate` datetime ,
 `modifieddate` datetime ,
 `status` varchar(10) ,
 ...
 `plan_bidsnos` int(11) ,
 `plan_feespercentage` decimal(10,0) ,
 `plan_nosofcategories` int(11) ,
 `plan_rate` decimal(10,0) ,
 `ofcmemplan_coupon` varchar(100) ,
 `ofcmemplan_discount` decimal(10,0) ,
 `ofcmemplan_paymentmethod` varchar(100) ,
 `ofcmemplan_ispaid` varchar(50) 
)*/;
...
/*View structure for view vw_ofcmember_plan_details */

/*!50001 DROP TABLE IF EXISTS `vw_ofcmember_plan_details` */;
/*!50001 DROP VIEW IF EXISTS `vw_ofcmember_plan_details` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_ofcmember_plan_details` AS (select `a`.`ofcmemplan_id` AS `ofcmemplan_id`,`a`.`ofcmembers_id_ofcmemplan` AS `ofcmembers_id_ofcmemplan`,`a`.`ofcmemplan_startdate` AS `ofcmemplan_startdate`,`a`.`ofcmemplan_enddate` AS `ofcmemplan_enddate`,`a`.`ofcmemplan_status` AS `ofcmemplan_status`,`a`.`ofcmemplan_rate` AS `ofcmemplan_rate`,`a`.`ofcmemplan_currency` AS `ofcmemplan_currency`,`a`.`ofcmemplan_coinsassigned` AS `ofcmemplan_coinsassigned`,`a`.`ofcmemplan_jobfees` AS `ofcmemplan_jobfees`,`a`.`ofcmemplan_nosofteammembers` AS `ofcmemplan_nosofteammembers`,`a`.`ofcmemplan_description` AS `ofcmemplan_description`,`a`.`createdate` AS `createdate`,`a`.`modifieddate` AS `modifieddate`,`a`.`status` AS `status`,`b`.`plan_id` AS `plan_id`,`b`.`plan_name` AS `plan_name`,`b`.`plan_bidsnos` AS `plan_bidsnos`,`b`.`plan_feespercentage` AS `plan_feespercentage`,`b`.`plan_nosofcategories` AS `plan_nosofcategories`,`b`.`plan_rate` AS `plan_rate`,`a`.`ofcmemplan_coupon` AS `ofcmemplan_coupon`,`a`.`ofcmemplan_discount` AS `ofcmemplan_discount`,`a`.`ofcmemplan_paymentmethod` AS `ofcmemplan_paymentmethod`,`a`.`ofcmemplan_ispaid` AS `ofcmemplan_ispaid` from (`tbl_ofcmemplan_details` `a` join `tbl_plan_master` `b`) where (`a`.`plan_id_ofcmemplan` = `b`.`plan_id`)) */;
