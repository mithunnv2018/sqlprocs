...
/* Procedure structure for procedure `proc_member_getall_transactions` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_getall_transactions` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_getall_transactions`(
    IN membersessionid VARCHAR(100),   
    OUT outparam json  
    )
label1:
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			CALL proc_common_selectjson('vw_ofcmember_plan_details',CONCAT('ofcmembers_id_ofcmemplan=\'',@memid,'\' order by createdate desc'),outparam);
...
/* Procedure structure for procedure `proc_member_get_activeplan` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_get_activeplan` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_get_activeplan`(
    IN membersessionid VARCHAR(100),   
    OUT outparam json  
    )
label1:
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			CALL proc_common_select_single_json('vw_ofcmember_plan_details',concat('ofcmembers_id_ofcmemplan=\'',@memid,'\' and ofcmemplan_status=\'active\''),outparam);
...
/* Procedure structure for procedure `proc_member_get_projectaccepted_byprojectpostid` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_get_projectaccepted_byprojectpostid` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_get_projectaccepted_byprojectpostid`(
    IN membersessionid VARCHAR(100),   
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			SET outparam=(SELECT CONCAT('[', (SELECT GROUP_CONCAT(CONCAT('{','"ofcmembers_fname":"',IF(ISNULL(maina.ofcmembers_fname),'-',maina.ofcmembers_fname),'",','"ofcmembers_mname":"',IF(ISNULL(maina.ofcmembers_mname),'-',maina.ofcmembers_mname),'",','"ofcmembers_lname":"',IF(ISNULL(maina.ofcmembers_lname),'-',maina.ofcmembers_lname),'",','"ofcmembers_name":"',IF(ISNULL(maina.ofcmembers_name),'-',maina.ofcmembers_name),'",','"ofcmember_type":"',IF(ISNULL(maina.ofcmember_type),'-',maina.ofcmember_type),'",','"city_id":"',IF(ISNULL(maina.city_id),'-',maina.city_id),'",','"ofcmembers_emailid":"',IF(ISNULL(maina.ofcmembers_emailid),'-',maina.ofcmembers_emailid),'",','"ofcmembers_password":"',IF(ISNULL(maina.ofcmembers_password),'-',maina.ofcmembers_password),'",','"ofcmembers_address1":"',IF(ISNULL(maina.ofcmembers_address1),'-',maina.ofcmembers_address1),'",','"ofcmembers_address2":"',IF(ISNULL(maina.ofcmembers_address2),'-',maina.ofcmembers_address2),'",','"ofcmembers_pincode":"',IF(ISNULL(maina.ofcmembers_pincode),'-',maina.ofcmembers_pincode),'",','"ofcmembers_contactnos":"',IF(ISNULL(maina.ofcmembers_contactnos),'-',maina.ofcmembers_contactnos),'",','"ofcmembers_availability":"',IF(ISNULL(maina.ofcmembers_availability),'-',maina.ofcmembers_availability),'",','"ofcmembers_displayname":"',IF(ISNULL(maina.ofcmembers_displayname),'-',maina.ofcmembers_displayname),'",','"ofcmembers_description":"',IF(ISNULL(maina.ofcmembers_description),'-',maina.ofcmembers_description),'",','"ofcmembers_selfrating":"',IF(ISNULL(maina.ofcmembers_selfrating),'-',maina.ofcmembers_selfrating),'",','"ofcmembers_experiencelevel":"',IF(ISNULL(maina.ofcmembers_experiencelevel),'-',maina.ofcmembers_experiencelevel),'",','"ofcmembers_gender":"',IF(ISNULL(maina.ofcmembers_gender),'-',maina.ofcmembers_gender),'",','"ofcmembers_dob":"',IF(ISNULL(maina.ofcmembers_dob),'-',UNIX_TIMESTAMP(maina.ofcmembers_dob)*1000),'",','"ofcmembers_nosofteammembers":"',IF(ISNULL(maina.ofcmembers_nosofteammembers),'-',maina.ofcmembers_nosofteammembers),'",','"city_name":"',IF(ISNULL(maina.city_name),'-',maina.city_name),'",','"country_name":"',IF(ISNULL(maina.country_name),'-',maina.country_name),'",','"state_name":"',IF(ISNULL(maina.state_name),'-',maina.state_name),'",','"ofcsubmitproposal_id":"',IF(ISNULL(maina.ofcsubmitproposal_id),'-',maina.ofcsubmitproposal_id),'",','"ofcprojectpost_id_fksubmitproposal":"',IF(ISNULL(maina.ofcprojectpost_id_fksubmitproposal),'-',maina.ofcprojectpost_id_fksubmitproposal),'",','"ofcmembers_id_fksubmitproposal":"',IF(ISNULL(maina.ofcmembers_id_fksubmitproposal),'-',maina.ofcmembers_id_fksubmitproposal),'",','"ofcsubmitproposal_coverletter":"',IF(ISNULL(maina.ofcsubmitproposal_coverletter),'-',maina.ofcsubmitproposal_coverletter),'",','"ofcsubmitproposal_budget":"',IF(ISNULL(maina.ofcsubmitproposal_budget),'-',maina.ofcsubmitproposal_budget),'",','"ofcsubmitproposal_negotiable":"',IF(ISNULL(maina.ofcsubmitproposal_negotiable),'-',maina.ofcsubmitproposal_negotiable),'",','"ofcsubmitproposal_commissionpercentage":"',IF(ISNULL(maina.ofcsubmitproposal_commissionpercentage),'-',maina.ofcsubmitproposal_commissionpercentage),'",','"ofcsubmitproposal_commissionamount":"',IF(ISNULL(maina.ofcsubmitproposal_commissionamount),'-',maina.ofcsubmitproposal_commissionamount),'",','"ofcsubmitproposal_finalamount":"',IF(ISNULL(maina.ofcsubmitproposal_finalamount),'-',maina.ofcsubmitproposal_finalamount),'",','"ofcsubmitproposal_timeframe":"',IF(ISNULL(maina.ofcsubmitproposal_timeframe),'-',maina.ofcsubmitproposal_timeframe),'",','"ofcsubmitproposal_availability":"',IF(ISNULL(maina.ofcsubmitproposal_availability),'-',maina.ofcsubmitproposal_availability),'",','"ofcsubmitproposal_status":"',IF(ISNULL(maina.ofcsubmitproposal_status),'-',maina.ofcsubmitproposal_status),'",','"ofcsubmitproposal_remarks":"',IF(ISNULL(maina.ofcsubmitproposal_remarks),'-',maina.ofcsubmitproposal_remarks),'",','"ofcsubmitproposal_terms":"',IF(ISNULL(maina.ofcsubmitproposal_terms),'-',maina.ofcsubmitproposal_terms),'",','"ofcsubmitproposal_estimatestartdate":"',IF(ISNULL(maina.ofcsubmitproposal_estimatestartdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_estimatestartdate)*1000),'",','"ofcsubmitproposal_startdate":"',IF(ISNULL(maina.ofcsubmitproposal_startdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_startdate)*1000),'",','"ofcsubmitproposal_enddate":"',IF(ISNULL(maina.ofcsubmitproposal_enddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_enddate)*1000),'",','"ofcsubmitproposal_estimatedays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedays),'-',maina.ofcsubmitproposal_estimatedays),'",','"ofcsubmitproposal_estimatedhoursindays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedhoursindays),'-',maina.ofcsubmitproposal_estimatedhoursindays),'",','"ofcsubmitproposal_reportabusebyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyemployeer),'-',maina.ofcsubmitproposal_reportabusebyemployeer),'",','"ofcsubmitproposal_reportabusebyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyfreelancer),'-',maina.ofcsubmitproposal_reportabusebyfreelancer),'",','"ofcsubmitproposal_proposalacceptdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalacceptdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalacceptdate)*1000),'",','"ofcsubmitproposal_proposalrejectdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalrejectdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalrejectdate)*1000),'",','"ofcsubmitproposal_completeddate":"',IF(ISNULL(maina.ofcsubmitproposal_completeddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_completeddate)*1000),'",','"ofcsubmitproposal_iscompletedbyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyemployeer),'-',maina.ofcsubmitproposal_iscompletedbyemployeer),'",','"ofcsubmitproposal_iscompletedbyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyfreelancer),'-',maina.ofcsubmitproposal_iscompletedbyfreelancer),'",','"ofcsubmitproposal_workstatus":"',IF(ISNULL(maina.ofcsubmitproposal_workstatus),'-',maina.ofcsubmitproposal_workstatus),'",','"createdate":"',IF(ISNULL(maina.createdate),'-',UNIX_TIMESTAMP(maina.createdate)*1000),'",','"modifieddate":"',IF(ISNULL(maina.modifieddate),'-',UNIX_TIMESTAMP(maina.modifieddate)*1000),'",','"status":"',IF(ISNULL(maina.status),'-',maina.status),'",','"questansarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalquest_id',sub0.ofcsubmitproposalquest_id,'ofcsubmitproposal_id_ofcsubmitproposalquest',sub0.ofcsubmitproposal_id_ofcsubmitproposalquest,'ofcsubmitproposalquest_question',sub0.ofcsubmitproposalquest_question,'ofcsubmitproposalquest_answer',sub0.ofcsubmitproposalquest_answer)) ,'],')FROM vw_vwofcmember_city_state_country_submitproposal_details main0, tbl_ofcsubmitproposal_questionanswers sub0 WHERE main0.ofcsubmitproposal_id=sub0.ofcsubmitproposal_id_ofcsubmitproposalquest AND sub0.ofcsubmitproposalquest_id = sub0.ofcsubmitproposalquest_id)),'"skillsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcmemberskill_id',sub1.ofcmemberskill_id,'skill_id',sub1.skill_id,'ofcmembers_id',sub1.ofcmembers_id,'createdate',UNIX_TIMESTAMP(sub1.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub1.modifieddate)*1000,'status',sub1.status)) ,']}')FROM vw_vwofcmember_city_state_country_submitproposal_details main1, tbl_ofcmemberskill_details sub1 WHERE main1.ofcmembers_id_fksubmitproposal=sub1.ofcmembers_id AND sub1.ofcmemberskill_id = sub1.ofcmemberskill_id))FROM vw_vwofcmember_city_state_country_submitproposal_details maina WHERE maina.ofcsubmitproposal_id=maina.ofcsubmitproposal_id AND  maina.ofcprojectpost_id_fksubmitproposal=ofcprojectpostid and maina.ofcsubmitproposal_status='bidding'),']'));
...
/* Procedure structure for procedure `proc_member_get_projectshortlisted_byprojectpostid` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_get_projectshortlisted_byprojectpostid` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_get_projectshortlisted_byprojectpostid`(
    IN membersessionid VARCHAR(100),   
    IN ofcprojectpostid VARCHAR(100),
    OUT outparam json  
    )
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			SET outparam=(SELECT CONCAT('[', (SELECT GROUP_CONCAT(CONCAT('{','"ofcmembers_fname":"',IF(ISNULL(maina.ofcmembers_fname),'-',maina.ofcmembers_fname),'",','"ofcmembers_mname":"',IF(ISNULL(maina.ofcmembers_mname),'-',maina.ofcmembers_mname),'",','"ofcmembers_lname":"',IF(ISNULL(maina.ofcmembers_lname),'-',maina.ofcmembers_lname),'",','"ofcmembers_name":"',IF(ISNULL(maina.ofcmembers_name),'-',maina.ofcmembers_name),'",','"ofcmember_type":"',IF(ISNULL(maina.ofcmember_type),'-',maina.ofcmember_type),'",','"city_id":"',IF(ISNULL(maina.city_id),'-',maina.city_id),'",','"ofcmembers_emailid":"',IF(ISNULL(maina.ofcmembers_emailid),'-',maina.ofcmembers_emailid),'",','"ofcmembers_password":"',IF(ISNULL(maina.ofcmembers_password),'-',maina.ofcmembers_password),'",','"ofcmembers_address1":"',IF(ISNULL(maina.ofcmembers_address1),'-',maina.ofcmembers_address1),'",','"ofcmembers_address2":"',IF(ISNULL(maina.ofcmembers_address2),'-',maina.ofcmembers_address2),'",','"ofcmembers_pincode":"',IF(ISNULL(maina.ofcmembers_pincode),'-',maina.ofcmembers_pincode),'",','"ofcmembers_contactnos":"',IF(ISNULL(maina.ofcmembers_contactnos),'-',maina.ofcmembers_contactnos),'",','"ofcmembers_availability":"',IF(ISNULL(maina.ofcmembers_availability),'-',maina.ofcmembers_availability),'",','"ofcmembers_displayname":"',IF(ISNULL(maina.ofcmembers_displayname),'-',maina.ofcmembers_displayname),'",','"ofcmembers_description":"',IF(ISNULL(maina.ofcmembers_description),'-',maina.ofcmembers_description),'",','"ofcmembers_selfrating":"',IF(ISNULL(maina.ofcmembers_selfrating),'-',maina.ofcmembers_selfrating),'",','"ofcmembers_experiencelevel":"',IF(ISNULL(maina.ofcmembers_experiencelevel),'-',maina.ofcmembers_experiencelevel),'",','"ofcmembers_gender":"',IF(ISNULL(maina.ofcmembers_gender),'-',maina.ofcmembers_gender),'",','"ofcmembers_dob":"',IF(ISNULL(maina.ofcmembers_dob),'-',UNIX_TIMESTAMP(maina.ofcmembers_dob)*1000),'",','"ofcmembers_nosofteammembers":"',IF(ISNULL(maina.ofcmembers_nosofteammembers),'-',maina.ofcmembers_nosofteammembers),'",','"city_name":"',IF(ISNULL(maina.city_name),'-',maina.city_name),'",','"country_name":"',IF(ISNULL(maina.country_name),'-',maina.country_name),'",','"state_name":"',IF(ISNULL(maina.state_name),'-',maina.state_name),'",','"ofcsubmitproposal_id":"',IF(ISNULL(maina.ofcsubmitproposal_id),'-',maina.ofcsubmitproposal_id),'",','"ofcprojectpost_id_fksubmitproposal":"',IF(ISNULL(maina.ofcprojectpost_id_fksubmitproposal),'-',maina.ofcprojectpost_id_fksubmitproposal),'",','"ofcmembers_id_fksubmitproposal":"',IF(ISNULL(maina.ofcmembers_id_fksubmitproposal),'-',maina.ofcmembers_id_fksubmitproposal),'",','"ofcsubmitproposal_coverletter":"',IF(ISNULL(maina.ofcsubmitproposal_coverletter),'-',maina.ofcsubmitproposal_coverletter),'",','"ofcsubmitproposal_budget":"',IF(ISNULL(maina.ofcsubmitproposal_budget),'-',maina.ofcsubmitproposal_budget),'",','"ofcsubmitproposal_negotiable":"',IF(ISNULL(maina.ofcsubmitproposal_negotiable),'-',maina.ofcsubmitproposal_negotiable),'",','"ofcsubmitproposal_commissionpercentage":"',IF(ISNULL(maina.ofcsubmitproposal_commissionpercentage),'-',maina.ofcsubmitproposal_commissionpercentage),'",','"ofcsubmitproposal_commissionamount":"',IF(ISNULL(maina.ofcsubmitproposal_commissionamount),'-',maina.ofcsubmitproposal_commissionamount),'",','"ofcsubmitproposal_finalamount":"',IF(ISNULL(maina.ofcsubmitproposal_finalamount),'-',maina.ofcsubmitproposal_finalamount),'",','"ofcsubmitproposal_timeframe":"',IF(ISNULL(maina.ofcsubmitproposal_timeframe),'-',maina.ofcsubmitproposal_timeframe),'",','"ofcsubmitproposal_availability":"',IF(ISNULL(maina.ofcsubmitproposal_availability),'-',maina.ofcsubmitproposal_availability),'",','"ofcsubmitproposal_status":"',IF(ISNULL(maina.ofcsubmitproposal_status),'-',maina.ofcsubmitproposal_status),'",','"ofcsubmitproposal_remarks":"',IF(ISNULL(maina.ofcsubmitproposal_remarks),'-',maina.ofcsubmitproposal_remarks),'",','"ofcsubmitproposal_terms":"',IF(ISNULL(maina.ofcsubmitproposal_terms),'-',maina.ofcsubmitproposal_terms),'",','"ofcsubmitproposal_estimatestartdate":"',IF(ISNULL(maina.ofcsubmitproposal_estimatestartdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_estimatestartdate)*1000),'",','"ofcsubmitproposal_startdate":"',IF(ISNULL(maina.ofcsubmitproposal_startdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_startdate)*1000),'",','"ofcsubmitproposal_enddate":"',IF(ISNULL(maina.ofcsubmitproposal_enddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_enddate)*1000),'",','"ofcsubmitproposal_estimatedays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedays),'-',maina.ofcsubmitproposal_estimatedays),'",','"ofcsubmitproposal_estimatedhoursindays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedhoursindays),'-',maina.ofcsubmitproposal_estimatedhoursindays),'",','"ofcsubmitproposal_reportabusebyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyemployeer),'-',maina.ofcsubmitproposal_reportabusebyemployeer),'",','"ofcsubmitproposal_reportabusebyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyfreelancer),'-',maina.ofcsubmitproposal_reportabusebyfreelancer),'",','"ofcsubmitproposal_proposalacceptdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalacceptdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalacceptdate)*1000),'",','"ofcsubmitproposal_proposalrejectdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalrejectdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalrejectdate)*1000),'",','"ofcsubmitproposal_completeddate":"',IF(ISNULL(maina.ofcsubmitproposal_completeddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_completeddate)*1000),'",','"ofcsubmitproposal_iscompletedbyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyemployeer),'-',maina.ofcsubmitproposal_iscompletedbyemployeer),'",','"ofcsubmitproposal_iscompletedbyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyfreelancer),'-',maina.ofcsubmitproposal_iscompletedbyfreelancer),'",','"ofcsubmitproposal_workstatus":"',IF(ISNULL(maina.ofcsubmitproposal_workstatus),'-',maina.ofcsubmitproposal_workstatus),'",','"createdate":"',IF(ISNULL(maina.createdate),'-',UNIX_TIMESTAMP(maina.createdate)*1000),'",','"modifieddate":"',IF(ISNULL(maina.modifieddate),'-',UNIX_TIMESTAMP(maina.modifieddate)*1000),'",','"status":"',IF(ISNULL(maina.status),'-',maina.status),'",','"questansarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalquest_id',sub0.ofcsubmitproposalquest_id,'ofcsubmitproposal_id_ofcsubmitproposalquest',sub0.ofcsubmitproposal_id_ofcsubmitproposalquest,'ofcsubmitproposalquest_question',sub0.ofcsubmitproposalquest_question,'ofcsubmitproposalquest_answer',sub0.ofcsubmitproposalquest_answer)) ,'],')FROM vw_vwofcmember_city_state_country_submitproposal_details main0, tbl_ofcsubmitproposal_questionanswers sub0 WHERE main0.ofcsubmitproposal_id=sub0.ofcsubmitproposal_id_ofcsubmitproposalquest AND sub0.ofcsubmitproposalquest_id = sub0.ofcsubmitproposalquest_id)),'"skillsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcmemberskill_id',sub1.ofcmemberskill_id,'skill_id',sub1.skill_id,'ofcmembers_id',sub1.ofcmembers_id,'createdate',UNIX_TIMESTAMP(sub1.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub1.modifieddate)*1000,'status',sub1.status)) ,']}')FROM vw_vwofcmember_city_state_country_submitproposal_details main1, tbl_ofcmemberskill_details sub1 WHERE main1.ofcmembers_id_fksubmitproposal=sub1.ofcmembers_id AND sub1.ofcmemberskill_id = sub1.ofcmemberskill_id))FROM vw_vwofcmember_city_state_country_submitproposal_details maina WHERE maina.ofcsubmitproposal_id=maina.ofcsubmitproposal_id AND  maina.ofcprojectpost_id_fksubmitproposal=ofcprojectpostid and maina.ofcsubmitproposal_status='shortlisted'),']'));
...
/* Procedure structure for procedure `proc_member_get_sumcoins` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_get_sumcoins` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_get_sumcoins`(
    IN membersessionid VARCHAR(100),   
    OUT sumcoins int,
    out outparam json  
    )
...
BEGIN
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 IF @memid IS NULL AND @memid = '' THEN
			...
			LEAVE label1;
		 ELSE
			set sumcoins= (select sum(ofcmemplanconsume_coins) from tbl_ofcmemplanconsume_details a,tbl_ofcmemplan_details b where a.ofcmemplan_id_ofcmemplanconsume=b.ofcmemplan_id and b.ofcmembers_id_ofcmemplan=@memid);
			-- CALL proc_common_select_single_json('vw_ofcmember_plan_details',concat('ofcmembers_id_ofcmemplan=\'',@memid,'\' ofcmemplan_status=\'active\''),outparam);
			if sumcoins is null then
				set sumcoins = 0;
			end if;		
		 END IF;
	...
	END IF;
	 ...
	 COMMIT;
     SET Isuccess = TRUE;
     SET Error = 'returned Successfully';
     SET outparam =  (SELECT JSON_OBJECT('Isuccess', Isuccess,
      'Error', Error,
     'Validation', Validation,
     'Controlid', Controlid));
...
/* Procedure structure for procedure `proc_member_ofcplan` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_ofcplan` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_ofcplan`(
    IN membersessionid VARCHAR(100),
    IN inparam json, -- tbl_ofcmemplan_details
    ...
    IF @truesession THEN
        -- SET istrue=TRUE;
         ...
         IF @memid IS NULL AND @memid = '' THEN
            ...
            LEAVE label1;
         ELSE
		update tbl_ofcmemplan_details
		set ofcmemplan_status = 'dormant'
		where ofcmembers_id_ofcmemplan = @memid and ofcmemplan_status='active';
         
            CALL proc_runningid('MPLAN',@p);
             INSERT INTO tbl_ofcmemplan_details
             (ofcmemplan_id,ofcmembers_id_ofcmemplan,plan_id_ofcmemplan,ofcmemplan_startdate,ofcmemplan_enddate,ofcmemplan_status,
             ofcmemplan_rate,ofcmemplan_currency,ofcmemplan_coinsassigned,ofcmemplan_jobfees,ofcmemplan_nosofteammembers,ofcmemplan_description,
             createdate,status,ofcmemplan_coupon,ofcmemplan_discount,ofcmemplan_paymentmethod,ofcmemplan_ispaid)
             VALUES(@p,
             @memid,
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].plan_id_ofcmemplan')),
             now(),
             NOW() + INTERVAL 1 MONTH,
             'active',
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_rate')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_currency')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_coinsassigned')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_jobfees')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_nosofteammembers')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_description')),                     
             NOW(),'active',
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_coupon')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_discount')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_paymentmethod')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_ispaid')));
             
             -- consumetype: inserted/bidding/postjob every activity will have coins consumption
             
             insert into tbl_ofcmemplanconsume_details
             (ofcmemplan_id_ofcmemplanconsume,ofcmemplanconsume_type,ofcmemplanconsume_coins,createdate,status)
             values(
		@p,'inserted',JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmemplan_coinsassigned')),now(),'active'
             );
...
/* Procedure structure for procedure `proc_member_ofcprojectsavecontactnos` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_ofcprojectsavecontactnos` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_ofcprojectsavecontactnos`(
    IN membersessionid VARCHAR(100),
    IN inparam json, -- tbl_ofcmembers_master
    OUT outparam json
    )
...
BEGIN
    ...
    IF @truesession THEN
		...
		update tbl_ofcmembers_master 
		set city_id=JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].city_id')),
		ofcmembers_address1=JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmembers_address1')),
		ofcmembers_address2=JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmembers_address2')),
		ofcmembers_pincode=JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmembers_pincode')),
		ofcmembers_contactnos=JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcmembers_contactnos'))
		where
		ofcmembers_id=@memid;
    ...
    END IF;
     ...
     COMMIT;
     SET Isuccess = TRUE;
     SET Error = 'Contact Details Saved Successfully..!';
     SET outparam =  (SELECT JSON_OBJECT('Isuccess', Isuccess,
         'Error', Error,
         'Validation', Validation,
       'Controlid', Controlid));
...
BEGIN
    ...
    IF @truesession THEN
      ...
      --      CALL proc_common_sub_insert(inquestions,'tbl_ofcprojectpost_questions','ofcprojectpost_id',@p,@output2);
           ...
           set @coinsbudget= (select ofcprojectpost_budget from tbl_ofcprojectpost_details where ofcprojectpost_id=JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcprojectpost_id_fksubmitproposal')));
           set @planid = (select ofcmemplan_id from tbl_ofcmemplan_details where ofcmembers_id_ofcmemplan=@memid);
           if @coinsbudget < 300 then
		insert into tbl_ofcmemplanconsume_details(ofcmemplan_id_ofcmemplanconsume,ofcsubmitproposal_id_ofcmemplanconsume,
		ofcmemplanconsume_type,ofcmemplanconsume_coins,createdate,status)
		values(@planid,@p,'submitproposal',-2,now(),'active');
           else
		INSERT INTO tbl_ofcmemplanconsume_details(ofcmemplan_id_ofcmemplanconsume,ofcsubmitproposal_id_ofcmemplanconsume,
		ofcmemplanconsume_type,ofcmemplanconsume_coins,createdate,STATUS)
		VALUES(@planid,@p,'submitproposal',-4,NOW(),'active');
           end if;
           SET outfileupload = @outparam2;
...
/* Procedure structure for procedure `proc_member_set_acceptoffer` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_set_acceptoffer` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_set_acceptoffer`(
    IN membersessionid VARCHAR(100),   
    IN ofcprojectsubmitid VARCHAR(100),
    OUT outparam json  
    )
label1:
BEGIN
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			-- set outparam=(SELECT CONCAT('[', (SELECT GROUP_CONCAT(CONCAT('{','"ofcsubmitproposal_id":"',IF(ISNULL(maina.ofcsubmitproposal_id),'-',maina.ofcsubmitproposal_id),'",','"ofcprojectpost_id_fksubmitproposal":"',IF(ISNULL(maina.ofcprojectpost_id_fksubmitproposal),'-',maina.ofcprojectpost_id_fksubmitproposal),'",','"ofcmembers_id_fksubmitproposal":"',IF(ISNULL(maina.ofcmembers_id_fksubmitproposal),'-',maina.ofcmembers_id_fksubmitproposal),'",','"ofcsubmitproposal_coverletter":"',IF(ISNULL(maina.ofcsubmitproposal_coverletter),'-',maina.ofcsubmitproposal_coverletter),'",','"ofcsubmitproposal_budget":"',IF(ISNULL(maina.ofcsubmitproposal_budget),'-',maina.ofcsubmitproposal_budget),'",','"ofcsubmitproposal_negotiable":"',IF(ISNULL(maina.ofcsubmitproposal_negotiable),'-',maina.ofcsubmitproposal_negotiable),'",','"ofcsubmitproposal_commissionpercentage":"',IF(ISNULL(maina.ofcsubmitproposal_commissionpercentage),'-',maina.ofcsubmitproposal_commissionpercentage),'",','"ofcsubmitproposal_commissionamount":"',IF(ISNULL(maina.ofcsubmitproposal_commissionamount),'-',maina.ofcsubmitproposal_commissionamount),'",','"ofcsubmitproposal_finalamount":"',IF(ISNULL(maina.ofcsubmitproposal_finalamount),'-',maina.ofcsubmitproposal_finalamount),'",','"ofcsubmitproposal_timeframe":"',IF(ISNULL(maina.ofcsubmitproposal_timeframe),'-',maina.ofcsubmitproposal_timeframe),'",','"ofcsubmitproposal_availability":"',IF(ISNULL(maina.ofcsubmitproposal_availability),'-',maina.ofcsubmitproposal_availability),'",','"ofcsubmitproposal_status":"',IF(ISNULL(maina.ofcsubmitproposal_status),'-',maina.ofcsubmitproposal_status),'",','"ofcsubmitproposal_remarks":"',IF(ISNULL(maina.ofcsubmitproposal_remarks),'-',maina.ofcsubmitproposal_remarks),'",','"ofcsubmitproposal_terms":"',IF(ISNULL(maina.ofcsubmitproposal_terms),'-',maina.ofcsubmitproposal_terms),'",','"ofcsubmitproposal_estimatestartdate":"',IF(ISNULL(maina.ofcsubmitproposal_estimatestartdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_estimatestartdate)*1000),'",','"ofcsubmitproposal_startdate":"',IF(ISNULL(maina.ofcsubmitproposal_startdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_startdate)*1000),'",','"ofcsubmitproposal_enddate":"',IF(ISNULL(maina.ofcsubmitproposal_enddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_enddate)*1000),'",','"ofcsubmitproposal_estimatedays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedays),'-',maina.ofcsubmitproposal_estimatedays),'",','"ofcsubmitproposal_estimatedhoursindays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedhoursindays),'-',maina.ofcsubmitproposal_estimatedhoursindays),'",','"ofcsubmitproposal_reportabusebyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyemployeer),'-',maina.ofcsubmitproposal_reportabusebyemployeer),'",','"ofcsubmitproposal_reportabusebyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyfreelancer),'-',maina.ofcsubmitproposal_reportabusebyfreelancer),'",','"ofcsubmitproposal_proposalacceptdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalacceptdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalacceptdate)*1000),'",','"ofcsubmitproposal_proposalrejectdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalrejectdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalrejectdate)*1000),'",','"ofcsubmitproposal_completeddate":"',IF(ISNULL(maina.ofcsubmitproposal_completeddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_completeddate)*1000),'",','"ofcsubmitproposal_iscompletedbyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyemployeer),'-',maina.ofcsubmitproposal_iscompletedbyemployeer),'",','"ofcsubmitproposal_iscompletedbyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyfreelancer),'-',maina.ofcsubmitproposal_iscompletedbyfreelancer),'",','"ofcsubmitproposal_workstatus":"',IF(ISNULL(maina.ofcsubmitproposal_workstatus),'-',maina.ofcsubmitproposal_workstatus),'",','"createdate":"',IF(ISNULL(maina.createdate),'-',UNIX_TIMESTAMP(maina.createdate)*1000),'",','"modifieddate":"',IF(ISNULL(maina.modifieddate),'-',UNIX_TIMESTAMP(maina.modifieddate)*1000),'",','"status":"',IF(ISNULL(maina.status),'-',maina.status),'",','"questansarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalquest_id',sub0.ofcsubmitproposalquest_id,'ofcsubmitproposal_id_ofcsubmitproposalquest',sub0.ofcsubmitproposal_id_ofcsubmitproposalquest,'ofcsubmitproposalquest_question',sub0.ofcsubmitproposalquest_question,'ofcsubmitproposalquest_answer',sub0.ofcsubmitproposalquest_answer)) ,'],')FROM tbl_ofcsubmitproposal_details main0, tbl_ofcsubmitproposal_questionanswers sub0 WHERE main0.ofcsubmitproposal_id=sub0.ofcsubmitproposal_id_ofcsubmitproposalquest AND sub0.ofcsubmitproposalquest_id = sub0.ofcsubmitproposalquest_id),'"termsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalterms_id',sub1.ofcsubmitproposalterms_id,'ofcsubmitproposal_id_fkterms',sub1.ofcsubmitproposal_id_fkterms,'ofcsubmitproposalterms_terms',sub1.ofcsubmitproposalterms_terms,'ofcsubmitproposalterms_agreedbyemployer',sub1.ofcsubmitproposalterms_agreedbyemployer,'ofcsubmitproposalterms_agreedbyemployee',sub1.ofcsubmitproposalterms_agreedbyemployee,'createdate',UNIX_TIMESTAMP(sub1.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub1.modifieddate)*1000,'status',sub1.status)) ,'],')FROM tbl_ofcsubmitproposal_details main1, tbl_ofcsubmitproposal_terms sub1 WHERE main1.ofcsubmitproposal_id=sub1.ofcsubmitproposal_id_fkterms AND sub1.ofcsubmitproposalterms_id = sub1.ofcsubmitproposalterms_id)),'"skillsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcmemberskill_id',sub2.ofcmemberskill_id,'skill_id',sub2.skill_id,'ofcmembers_id',sub2.ofcmembers_id,'createdate',UNIX_TIMESTAMP(sub2.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub2.modifieddate)*1000,'status',sub2.status)) ,']}')FROM tbl_ofcsubmitproposal_details main2, tbl_ofcmemberskill_details sub2 WHERE main2.ofcsubmitproposal_id=sub2.ofcmembers_id AND sub2.ofcmemberskill_id = sub2.ofcmemberskill_id))FROM tbl_ofcsubmitproposal_details maina WHERE maina.ofcsubmitproposal_id=maina.ofcsubmitproposal_id and maina.ofcprojectpost_id_fksubmitproposal=ofcprojectpostid ),']')
			-- );			
			set @memberid = (select ofcmembers_id_fksubmitproposal from tbl_ofcsubmitproposal_details where ofcmembers_id_fksubmitproposal=@memid);
			
			if  @memberid is not null then
				update tbl_ofcsubmitproposal_details 
				set ofcsubmitproposal_status='accepted'
				where ofcsubmitproposal_id = ofcprojectsubmitid;
				SET Error = 'Offer Accepted Successfully';
			else
				SET Error = 'You are not Authorized to accept this Offer';
			end if;
			-- SET outparam=(SELECT CONCAT('[', (SELECT GROUP_CONCAT(CONCAT('{','"ofcmembers_fname":"',IF(ISNULL(maina.ofcmembers_fname),'-',maina.ofcmembers_fname),'",','"ofcmembers_mname":"',IF(ISNULL(maina.ofcmembers_mname),'-',maina.ofcmembers_mname),'",','"ofcmembers_lname":"',IF(ISNULL(maina.ofcmembers_lname),'-',maina.ofcmembers_lname),'",','"ofcmembers_name":"',IF(ISNULL(maina.ofcmembers_name),'-',maina.ofcmembers_name),'",','"ofcmember_type":"',IF(ISNULL(maina.ofcmember_type),'-',maina.ofcmember_type),'",','"city_id":"',IF(ISNULL(maina.city_id),'-',maina.city_id),'",','"ofcmembers_emailid":"',IF(ISNULL(maina.ofcmembers_emailid),'-',maina.ofcmembers_emailid),'",','"ofcmembers_password":"',IF(ISNULL(maina.ofcmembers_password),'-',maina.ofcmembers_password),'",','"ofcmembers_address1":"',IF(ISNULL(maina.ofcmembers_address1),'-',maina.ofcmembers_address1),'",','"ofcmembers_address2":"',IF(ISNULL(maina.ofcmembers_address2),'-',maina.ofcmembers_address2),'",','"ofcmembers_pincode":"',IF(ISNULL(maina.ofcmembers_pincode),'-',maina.ofcmembers_pincode),'",','"ofcmembers_contactnos":"',IF(ISNULL(maina.ofcmembers_contactnos),'-',maina.ofcmembers_contactnos),'",','"ofcmembers_availability":"',IF(ISNULL(maina.ofcmembers_availability),'-',maina.ofcmembers_availability),'",','"ofcmembers_displayname":"',IF(ISNULL(maina.ofcmembers_displayname),'-',maina.ofcmembers_displayname),'",','"ofcmembers_description":"',IF(ISNULL(maina.ofcmembers_description),'-',maina.ofcmembers_description),'",','"ofcmembers_selfrating":"',IF(ISNULL(maina.ofcmembers_selfrating),'-',maina.ofcmembers_selfrating),'",','"ofcmembers_experiencelevel":"',IF(ISNULL(maina.ofcmembers_experiencelevel),'-',maina.ofcmembers_experiencelevel),'",','"ofcmembers_gender":"',IF(ISNULL(maina.ofcmembers_gender),'-',maina.ofcmembers_gender),'",','"ofcmembers_dob":"',IF(ISNULL(maina.ofcmembers_dob),'-',UNIX_TIMESTAMP(maina.ofcmembers_dob)*1000),'",','"ofcmembers_nosofteammembers":"',IF(ISNULL(maina.ofcmembers_nosofteammembers),'-',maina.ofcmembers_nosofteammembers),'",','"city_name":"',IF(ISNULL(maina.city_name),'-',maina.city_name),'",','"country_name":"',IF(ISNULL(maina.country_name),'-',maina.country_name),'",','"state_name":"',IF(ISNULL(maina.state_name),'-',maina.state_name),'",','"ofcsubmitproposal_id":"',IF(ISNULL(maina.ofcsubmitproposal_id),'-',maina.ofcsubmitproposal_id),'",','"ofcprojectpost_id_fksubmitproposal":"',IF(ISNULL(maina.ofcprojectpost_id_fksubmitproposal),'-',maina.ofcprojectpost_id_fksubmitproposal),'",','"ofcmembers_id_fksubmitproposal":"',IF(ISNULL(maina.ofcmembers_id_fksubmitproposal),'-',maina.ofcmembers_id_fksubmitproposal),'",','"ofcsubmitproposal_coverletter":"',IF(ISNULL(maina.ofcsubmitproposal_coverletter),'-',maina.ofcsubmitproposal_coverletter),'",','"ofcsubmitproposal_budget":"',IF(ISNULL(maina.ofcsubmitproposal_budget),'-',maina.ofcsubmitproposal_budget),'",','"ofcsubmitproposal_negotiable":"',IF(ISNULL(maina.ofcsubmitproposal_negotiable),'-',maina.ofcsubmitproposal_negotiable),'",','"ofcsubmitproposal_commissionpercentage":"',IF(ISNULL(maina.ofcsubmitproposal_commissionpercentage),'-',maina.ofcsubmitproposal_commissionpercentage),'",','"ofcsubmitproposal_commissionamount":"',IF(ISNULL(maina.ofcsubmitproposal_commissionamount),'-',maina.ofcsubmitproposal_commissionamount),'",','"ofcsubmitproposal_finalamount":"',IF(ISNULL(maina.ofcsubmitproposal_finalamount),'-',maina.ofcsubmitproposal_finalamount),'",','"ofcsubmitproposal_timeframe":"',IF(ISNULL(maina.ofcsubmitproposal_timeframe),'-',maina.ofcsubmitproposal_timeframe),'",','"ofcsubmitproposal_availability":"',IF(ISNULL(maina.ofcsubmitproposal_availability),'-',maina.ofcsubmitproposal_availability),'",','"ofcsubmitproposal_status":"',IF(ISNULL(maina.ofcsubmitproposal_status),'-',maina.ofcsubmitproposal_status),'",','"ofcsubmitproposal_remarks":"',IF(ISNULL(maina.ofcsubmitproposal_remarks),'-',maina.ofcsubmitproposal_remarks),'",','"ofcsubmitproposal_terms":"',IF(ISNULL(maina.ofcsubmitproposal_terms),'-',maina.ofcsubmitproposal_terms),'",','"ofcsubmitproposal_estimatestartdate":"',IF(ISNULL(maina.ofcsubmitproposal_estimatestartdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_estimatestartdate)*1000),'",','"ofcsubmitproposal_startdate":"',IF(ISNULL(maina.ofcsubmitproposal_startdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_startdate)*1000),'",','"ofcsubmitproposal_enddate":"',IF(ISNULL(maina.ofcsubmitproposal_enddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_enddate)*1000),'",','"ofcsubmitproposal_estimatedays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedays),'-',maina.ofcsubmitproposal_estimatedays),'",','"ofcsubmitproposal_estimatedhoursindays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedhoursindays),'-',maina.ofcsubmitproposal_estimatedhoursindays),'",','"ofcsubmitproposal_reportabusebyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyemployeer),'-',maina.ofcsubmitproposal_reportabusebyemployeer),'",','"ofcsubmitproposal_reportabusebyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyfreelancer),'-',maina.ofcsubmitproposal_reportabusebyfreelancer),'",','"ofcsubmitproposal_proposalacceptdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalacceptdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalacceptdate)*1000),'",','"ofcsubmitproposal_proposalrejectdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalrejectdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalrejectdate)*1000),'",','"ofcsubmitproposal_completeddate":"',IF(ISNULL(maina.ofcsubmitproposal_completeddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_completeddate)*1000),'",','"ofcsubmitproposal_iscompletedbyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyemployeer),'-',maina.ofcsubmitproposal_iscompletedbyemployeer),'",','"ofcsubmitproposal_iscompletedbyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyfreelancer),'-',maina.ofcsubmitproposal_iscompletedbyfreelancer),'",','"ofcsubmitproposal_workstatus":"',IF(ISNULL(maina.ofcsubmitproposal_workstatus),'-',maina.ofcsubmitproposal_workstatus),'",','"createdate":"',IF(ISNULL(maina.createdate),'-',UNIX_TIMESTAMP(maina.createdate)*1000),'",','"modifieddate":"',IF(ISNULL(maina.modifieddate),'-',UNIX_TIMESTAMP(maina.modifieddate)*1000),'",','"status":"',IF(ISNULL(maina.status),'-',maina.status),'",','"questansarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalquest_id',sub0.ofcsubmitproposalquest_id,'ofcsubmitproposal_id_ofcsubmitproposalquest',sub0.ofcsubmitproposal_id_ofcsubmitproposalquest,'ofcsubmitproposalquest_question',sub0.ofcsubmitproposalquest_question,'ofcsubmitproposalquest_answer',sub0.ofcsubmitproposalquest_answer)) ,'],')FROM vw_vwofcmember_city_state_country_submitproposal_details main0, tbl_ofcsubmitproposal_questionanswers sub0 WHERE main0.ofcsubmitproposal_id=sub0.ofcsubmitproposal_id_ofcsubmitproposalquest AND sub0.ofcsubmitproposalquest_id = sub0.ofcsubmitproposalquest_id)),'"skillsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcmemberskill_id',sub1.ofcmemberskill_id,'skill_id',sub1.skill_id,'ofcmembers_id',sub1.ofcmembers_id,'createdate',UNIX_TIMESTAMP(sub1.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub1.modifieddate)*1000,'status',sub1.status)) ,']}')FROM vw_vwofcmember_city_state_country_submitproposal_details main1, tbl_ofcmemberskill_details sub1 WHERE main1.ofcmembers_id_fksubmitproposal=sub1.ofcmembers_id AND sub1.ofcmemberskill_id = sub1.ofcmemberskill_id))FROM vw_vwofcmember_city_state_country_submitproposal_details maina WHERE maina.ofcsubmitproposal_id=maina.ofcsubmitproposal_id AND  maina.ofcprojectpost_id_fksubmitproposal=ofcprojectpostid ),']'));
...
/* Procedure structure for procedure `proc_member_set_rejectedoffer` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_set_rejectedoffer` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_set_rejectedoffer`(
    IN membersessionid VARCHAR(100),   
    IN ofcprojectsubmitid VARCHAR(100),
    OUT outparam json  
    )
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			if  @memberid is not null then
				update tbl_ofcsubmitproposal_details 
				set ofcsubmitproposal_status='rejected', status='dormant'
				where ofcsubmitproposal_id = ofcprojectsubmitid;
				SET Error = 'Offer Rejected Successfully';
			else
				SET Error = 'You are not Authorized to accept this Offer';
			end if;
			-- SET outparam=(SELECT CONCAT('[', (SELECT GROUP_CONCAT(CONCAT('{','"ofcmembers_fname":"',IF(ISNULL(maina.ofcmembers_fname),'-',maina.ofcmembers_fname),'",','"ofcmembers_mname":"',IF(ISNULL(maina.ofcmembers_mname),'-',maina.ofcmembers_mname),'",','"ofcmembers_lname":"',IF(ISNULL(maina.ofcmembers_lname),'-',maina.ofcmembers_lname),'",','"ofcmembers_name":"',IF(ISNULL(maina.ofcmembers_name),'-',maina.ofcmembers_name),'",','"ofcmember_type":"',IF(ISNULL(maina.ofcmember_type),'-',maina.ofcmember_type),'",','"city_id":"',IF(ISNULL(maina.city_id),'-',maina.city_id),'",','"ofcmembers_emailid":"',IF(ISNULL(maina.ofcmembers_emailid),'-',maina.ofcmembers_emailid),'",','"ofcmembers_password":"',IF(ISNULL(maina.ofcmembers_password),'-',maina.ofcmembers_password),'",','"ofcmembers_address1":"',IF(ISNULL(maina.ofcmembers_address1),'-',maina.ofcmembers_address1),'",','"ofcmembers_address2":"',IF(ISNULL(maina.ofcmembers_address2),'-',maina.ofcmembers_address2),'",','"ofcmembers_pincode":"',IF(ISNULL(maina.ofcmembers_pincode),'-',maina.ofcmembers_pincode),'",','"ofcmembers_contactnos":"',IF(ISNULL(maina.ofcmembers_contactnos),'-',maina.ofcmembers_contactnos),'",','"ofcmembers_availability":"',IF(ISNULL(maina.ofcmembers_availability),'-',maina.ofcmembers_availability),'",','"ofcmembers_displayname":"',IF(ISNULL(maina.ofcmembers_displayname),'-',maina.ofcmembers_displayname),'",','"ofcmembers_description":"',IF(ISNULL(maina.ofcmembers_description),'-',maina.ofcmembers_description),'",','"ofcmembers_selfrating":"',IF(ISNULL(maina.ofcmembers_selfrating),'-',maina.ofcmembers_selfrating),'",','"ofcmembers_experiencelevel":"',IF(ISNULL(maina.ofcmembers_experiencelevel),'-',maina.ofcmembers_experiencelevel),'",','"ofcmembers_gender":"',IF(ISNULL(maina.ofcmembers_gender),'-',maina.ofcmembers_gender),'",','"ofcmembers_dob":"',IF(ISNULL(maina.ofcmembers_dob),'-',UNIX_TIMESTAMP(maina.ofcmembers_dob)*1000),'",','"ofcmembers_nosofteammembers":"',IF(ISNULL(maina.ofcmembers_nosofteammembers),'-',maina.ofcmembers_nosofteammembers),'",','"city_name":"',IF(ISNULL(maina.city_name),'-',maina.city_name),'",','"country_name":"',IF(ISNULL(maina.country_name),'-',maina.country_name),'",','"state_name":"',IF(ISNULL(maina.state_name),'-',maina.state_name),'",','"ofcsubmitproposal_id":"',IF(ISNULL(maina.ofcsubmitproposal_id),'-',maina.ofcsubmitproposal_id),'",','"ofcprojectpost_id_fksubmitproposal":"',IF(ISNULL(maina.ofcprojectpost_id_fksubmitproposal),'-',maina.ofcprojectpost_id_fksubmitproposal),'",','"ofcmembers_id_fksubmitproposal":"',IF(ISNULL(maina.ofcmembers_id_fksubmitproposal),'-',maina.ofcmembers_id_fksubmitproposal),'",','"ofcsubmitproposal_coverletter":"',IF(ISNULL(maina.ofcsubmitproposal_coverletter),'-',maina.ofcsubmitproposal_coverletter),'",','"ofcsubmitproposal_budget":"',IF(ISNULL(maina.ofcsubmitproposal_budget),'-',maina.ofcsubmitproposal_budget),'",','"ofcsubmitproposal_negotiable":"',IF(ISNULL(maina.ofcsubmitproposal_negotiable),'-',maina.ofcsubmitproposal_negotiable),'",','"ofcsubmitproposal_commissionpercentage":"',IF(ISNULL(maina.ofcsubmitproposal_commissionpercentage),'-',maina.ofcsubmitproposal_commissionpercentage),'",','"ofcsubmitproposal_commissionamount":"',IF(ISNULL(maina.ofcsubmitproposal_commissionamount),'-',maina.ofcsubmitproposal_commissionamount),'",','"ofcsubmitproposal_finalamount":"',IF(ISNULL(maina.ofcsubmitproposal_finalamount),'-',maina.ofcsubmitproposal_finalamount),'",','"ofcsubmitproposal_timeframe":"',IF(ISNULL(maina.ofcsubmitproposal_timeframe),'-',maina.ofcsubmitproposal_timeframe),'",','"ofcsubmitproposal_availability":"',IF(ISNULL(maina.ofcsubmitproposal_availability),'-',maina.ofcsubmitproposal_availability),'",','"ofcsubmitproposal_status":"',IF(ISNULL(maina.ofcsubmitproposal_status),'-',maina.ofcsubmitproposal_status),'",','"ofcsubmitproposal_remarks":"',IF(ISNULL(maina.ofcsubmitproposal_remarks),'-',maina.ofcsubmitproposal_remarks),'",','"ofcsubmitproposal_terms":"',IF(ISNULL(maina.ofcsubmitproposal_terms),'-',maina.ofcsubmitproposal_terms),'",','"ofcsubmitproposal_estimatestartdate":"',IF(ISNULL(maina.ofcsubmitproposal_estimatestartdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_estimatestartdate)*1000),'",','"ofcsubmitproposal_startdate":"',IF(ISNULL(maina.ofcsubmitproposal_startdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_startdate)*1000),'",','"ofcsubmitproposal_enddate":"',IF(ISNULL(maina.ofcsubmitproposal_enddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_enddate)*1000),'",','"ofcsubmitproposal_estimatedays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedays),'-',maina.ofcsubmitproposal_estimatedays),'",','"ofcsubmitproposal_estimatedhoursindays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedhoursindays),'-',maina.ofcsubmitproposal_estimatedhoursindays),'",','"ofcsubmitproposal_reportabusebyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyemployeer),'-',maina.ofcsubmitproposal_reportabusebyemployeer),'",','"ofcsubmitproposal_reportabusebyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyfreelancer),'-',maina.ofcsubmitproposal_reportabusebyfreelancer),'",','"ofcsubmitproposal_proposalacceptdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalacceptdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalacceptdate)*1000),'",','"ofcsubmitproposal_proposalrejectdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalrejectdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalrejectdate)*1000),'",','"ofcsubmitproposal_completeddate":"',IF(ISNULL(maina.ofcsubmitproposal_completeddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_completeddate)*1000),'",','"ofcsubmitproposal_iscompletedbyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyemployeer),'-',maina.ofcsubmitproposal_iscompletedbyemployeer),'",','"ofcsubmitproposal_iscompletedbyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyfreelancer),'-',maina.ofcsubmitproposal_iscompletedbyfreelancer),'",','"ofcsubmitproposal_workstatus":"',IF(ISNULL(maina.ofcsubmitproposal_workstatus),'-',maina.ofcsubmitproposal_workstatus),'",','"createdate":"',IF(ISNULL(maina.createdate),'-',UNIX_TIMESTAMP(maina.createdate)*1000),'",','"modifieddate":"',IF(ISNULL(maina.modifieddate),'-',UNIX_TIMESTAMP(maina.modifieddate)*1000),'",','"status":"',IF(ISNULL(maina.status),'-',maina.status),'",','"questansarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalquest_id',sub0.ofcsubmitproposalquest_id,'ofcsubmitproposal_id_ofcsubmitproposalquest',sub0.ofcsubmitproposal_id_ofcsubmitproposalquest,'ofcsubmitproposalquest_question',sub0.ofcsubmitproposalquest_question,'ofcsubmitproposalquest_answer',sub0.ofcsubmitproposalquest_answer)) ,'],')FROM vw_vwofcmember_city_state_country_submitproposal_details main0, tbl_ofcsubmitproposal_questionanswers sub0 WHERE main0.ofcsubmitproposal_id=sub0.ofcsubmitproposal_id_ofcsubmitproposalquest AND sub0.ofcsubmitproposalquest_id = sub0.ofcsubmitproposalquest_id)),'"skillsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcmemberskill_id',sub1.ofcmemberskill_id,'skill_id',sub1.skill_id,'ofcmembers_id',sub1.ofcmembers_id,'createdate',UNIX_TIMESTAMP(sub1.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub1.modifieddate)*1000,'status',sub1.status)) ,']}')FROM vw_vwofcmember_city_state_country_submitproposal_details main1, tbl_ofcmemberskill_details sub1 WHERE main1.ofcmembers_id_fksubmitproposal=sub1.ofcmembers_id AND sub1.ofcmemberskill_id = sub1.ofcmemberskill_id))FROM vw_vwofcmember_city_state_country_submitproposal_details maina WHERE maina.ofcsubmitproposal_id=maina.ofcsubmitproposal_id AND  maina.ofcprojectpost_id_fksubmitproposal=ofcprojectpostid ),']'));
...
/* Procedure structure for procedure `proc_member_set_removejobposting` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_set_removejobposting` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_set_removejobposting`(
    IN membersessionid VARCHAR(100),   
    IN ofcprojectpostid VARCHAR(100),
    OUT outparam json  
    )
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			if  @memberid is not null then
				update tbl_ofcprojectpost_details 
				set  status='dormant'
				where ofcsubmitproposal_id = ofcprojectpostid;
				SET Error = 'Posting Removed Successfully';
			else
				SET Error = 'You are not Authorized to accept this Offer';
			end if;
			-- SET outparam=(SELECT CONCAT('[', (SELECT GROUP_CONCAT(CONCAT('{','"ofcmembers_fname":"',IF(ISNULL(maina.ofcmembers_fname),'-',maina.ofcmembers_fname),'",','"ofcmembers_mname":"',IF(ISNULL(maina.ofcmembers_mname),'-',maina.ofcmembers_mname),'",','"ofcmembers_lname":"',IF(ISNULL(maina.ofcmembers_lname),'-',maina.ofcmembers_lname),'",','"ofcmembers_name":"',IF(ISNULL(maina.ofcmembers_name),'-',maina.ofcmembers_name),'",','"ofcmember_type":"',IF(ISNULL(maina.ofcmember_type),'-',maina.ofcmember_type),'",','"city_id":"',IF(ISNULL(maina.city_id),'-',maina.city_id),'",','"ofcmembers_emailid":"',IF(ISNULL(maina.ofcmembers_emailid),'-',maina.ofcmembers_emailid),'",','"ofcmembers_password":"',IF(ISNULL(maina.ofcmembers_password),'-',maina.ofcmembers_password),'",','"ofcmembers_address1":"',IF(ISNULL(maina.ofcmembers_address1),'-',maina.ofcmembers_address1),'",','"ofcmembers_address2":"',IF(ISNULL(maina.ofcmembers_address2),'-',maina.ofcmembers_address2),'",','"ofcmembers_pincode":"',IF(ISNULL(maina.ofcmembers_pincode),'-',maina.ofcmembers_pincode),'",','"ofcmembers_contactnos":"',IF(ISNULL(maina.ofcmembers_contactnos),'-',maina.ofcmembers_contactnos),'",','"ofcmembers_availability":"',IF(ISNULL(maina.ofcmembers_availability),'-',maina.ofcmembers_availability),'",','"ofcmembers_displayname":"',IF(ISNULL(maina.ofcmembers_displayname),'-',maina.ofcmembers_displayname),'",','"ofcmembers_description":"',IF(ISNULL(maina.ofcmembers_description),'-',maina.ofcmembers_description),'",','"ofcmembers_selfrating":"',IF(ISNULL(maina.ofcmembers_selfrating),'-',maina.ofcmembers_selfrating),'",','"ofcmembers_experiencelevel":"',IF(ISNULL(maina.ofcmembers_experiencelevel),'-',maina.ofcmembers_experiencelevel),'",','"ofcmembers_gender":"',IF(ISNULL(maina.ofcmembers_gender),'-',maina.ofcmembers_gender),'",','"ofcmembers_dob":"',IF(ISNULL(maina.ofcmembers_dob),'-',UNIX_TIMESTAMP(maina.ofcmembers_dob)*1000),'",','"ofcmembers_nosofteammembers":"',IF(ISNULL(maina.ofcmembers_nosofteammembers),'-',maina.ofcmembers_nosofteammembers),'",','"city_name":"',IF(ISNULL(maina.city_name),'-',maina.city_name),'",','"country_name":"',IF(ISNULL(maina.country_name),'-',maina.country_name),'",','"state_name":"',IF(ISNULL(maina.state_name),'-',maina.state_name),'",','"ofcsubmitproposal_id":"',IF(ISNULL(maina.ofcsubmitproposal_id),'-',maina.ofcsubmitproposal_id),'",','"ofcprojectpost_id_fksubmitproposal":"',IF(ISNULL(maina.ofcprojectpost_id_fksubmitproposal),'-',maina.ofcprojectpost_id_fksubmitproposal),'",','"ofcmembers_id_fksubmitproposal":"',IF(ISNULL(maina.ofcmembers_id_fksubmitproposal),'-',maina.ofcmembers_id_fksubmitproposal),'",','"ofcsubmitproposal_coverletter":"',IF(ISNULL(maina.ofcsubmitproposal_coverletter),'-',maina.ofcsubmitproposal_coverletter),'",','"ofcsubmitproposal_budget":"',IF(ISNULL(maina.ofcsubmitproposal_budget),'-',maina.ofcsubmitproposal_budget),'",','"ofcsubmitproposal_negotiable":"',IF(ISNULL(maina.ofcsubmitproposal_negotiable),'-',maina.ofcsubmitproposal_negotiable),'",','"ofcsubmitproposal_commissionpercentage":"',IF(ISNULL(maina.ofcsubmitproposal_commissionpercentage),'-',maina.ofcsubmitproposal_commissionpercentage),'",','"ofcsubmitproposal_commissionamount":"',IF(ISNULL(maina.ofcsubmitproposal_commissionamount),'-',maina.ofcsubmitproposal_commissionamount),'",','"ofcsubmitproposal_finalamount":"',IF(ISNULL(maina.ofcsubmitproposal_finalamount),'-',maina.ofcsubmitproposal_finalamount),'",','"ofcsubmitproposal_timeframe":"',IF(ISNULL(maina.ofcsubmitproposal_timeframe),'-',maina.ofcsubmitproposal_timeframe),'",','"ofcsubmitproposal_availability":"',IF(ISNULL(maina.ofcsubmitproposal_availability),'-',maina.ofcsubmitproposal_availability),'",','"ofcsubmitproposal_status":"',IF(ISNULL(maina.ofcsubmitproposal_status),'-',maina.ofcsubmitproposal_status),'",','"ofcsubmitproposal_remarks":"',IF(ISNULL(maina.ofcsubmitproposal_remarks),'-',maina.ofcsubmitproposal_remarks),'",','"ofcsubmitproposal_terms":"',IF(ISNULL(maina.ofcsubmitproposal_terms),'-',maina.ofcsubmitproposal_terms),'",','"ofcsubmitproposal_estimatestartdate":"',IF(ISNULL(maina.ofcsubmitproposal_estimatestartdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_estimatestartdate)*1000),'",','"ofcsubmitproposal_startdate":"',IF(ISNULL(maina.ofcsubmitproposal_startdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_startdate)*1000),'",','"ofcsubmitproposal_enddate":"',IF(ISNULL(maina.ofcsubmitproposal_enddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_enddate)*1000),'",','"ofcsubmitproposal_estimatedays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedays),'-',maina.ofcsubmitproposal_estimatedays),'",','"ofcsubmitproposal_estimatedhoursindays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedhoursindays),'-',maina.ofcsubmitproposal_estimatedhoursindays),'",','"ofcsubmitproposal_reportabusebyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyemployeer),'-',maina.ofcsubmitproposal_reportabusebyemployeer),'",','"ofcsubmitproposal_reportabusebyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyfreelancer),'-',maina.ofcsubmitproposal_reportabusebyfreelancer),'",','"ofcsubmitproposal_proposalacceptdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalacceptdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalacceptdate)*1000),'",','"ofcsubmitproposal_proposalrejectdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalrejectdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalrejectdate)*1000),'",','"ofcsubmitproposal_completeddate":"',IF(ISNULL(maina.ofcsubmitproposal_completeddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_completeddate)*1000),'",','"ofcsubmitproposal_iscompletedbyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyemployeer),'-',maina.ofcsubmitproposal_iscompletedbyemployeer),'",','"ofcsubmitproposal_iscompletedbyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyfreelancer),'-',maina.ofcsubmitproposal_iscompletedbyfreelancer),'",','"ofcsubmitproposal_workstatus":"',IF(ISNULL(maina.ofcsubmitproposal_workstatus),'-',maina.ofcsubmitproposal_workstatus),'",','"createdate":"',IF(ISNULL(maina.createdate),'-',UNIX_TIMESTAMP(maina.createdate)*1000),'",','"modifieddate":"',IF(ISNULL(maina.modifieddate),'-',UNIX_TIMESTAMP(maina.modifieddate)*1000),'",','"status":"',IF(ISNULL(maina.status),'-',maina.status),'",','"questansarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalquest_id',sub0.ofcsubmitproposalquest_id,'ofcsubmitproposal_id_ofcsubmitproposalquest',sub0.ofcsubmitproposal_id_ofcsubmitproposalquest,'ofcsubmitproposalquest_question',sub0.ofcsubmitproposalquest_question,'ofcsubmitproposalquest_answer',sub0.ofcsubmitproposalquest_answer)) ,'],')FROM vw_vwofcmember_city_state_country_submitproposal_details main0, tbl_ofcsubmitproposal_questionanswers sub0 WHERE main0.ofcsubmitproposal_id=sub0.ofcsubmitproposal_id_ofcsubmitproposalquest AND sub0.ofcsubmitproposalquest_id = sub0.ofcsubmitproposalquest_id)),'"skillsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcmemberskill_id',sub1.ofcmemberskill_id,'skill_id',sub1.skill_id,'ofcmembers_id',sub1.ofcmembers_id,'createdate',UNIX_TIMESTAMP(sub1.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub1.modifieddate)*1000,'status',sub1.status)) ,']}')FROM vw_vwofcmember_city_state_country_submitproposal_details main1, tbl_ofcmemberskill_details sub1 WHERE main1.ofcmembers_id_fksubmitproposal=sub1.ofcmembers_id AND sub1.ofcmemberskill_id = sub1.ofcmemberskill_id))FROM vw_vwofcmember_city_state_country_submitproposal_details maina WHERE maina.ofcsubmitproposal_id=maina.ofcsubmitproposal_id AND  maina.ofcprojectpost_id_fksubmitproposal=ofcprojectpostid ),']'));
...
/* Procedure structure for procedure `proc_member_set_shortlistoffer` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_member_set_shortlistoffer` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_member_set_shortlistoffer`(
    IN membersessionid VARCHAR(100),   
    IN ofcprojectsubmitid VARCHAR(100),
    OUT outparam json  
    )
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			if  @memberid is not null then
				update tbl_ofcsubmitproposal_details 
				set ofcsubmitproposal_status='shortlisted'
				where ofcsubmitproposal_id = ofcprojectsubmitid;
				SET Error = 'Offer Shortlisted Successfully';
			else
				SET Error = 'You are not Authorized to accept this Offer';
			end if;
			-- SET outparam=(SELECT CONCAT('[', (SELECT GROUP_CONCAT(CONCAT('{','"ofcmembers_fname":"',IF(ISNULL(maina.ofcmembers_fname),'-',maina.ofcmembers_fname),'",','"ofcmembers_mname":"',IF(ISNULL(maina.ofcmembers_mname),'-',maina.ofcmembers_mname),'",','"ofcmembers_lname":"',IF(ISNULL(maina.ofcmembers_lname),'-',maina.ofcmembers_lname),'",','"ofcmembers_name":"',IF(ISNULL(maina.ofcmembers_name),'-',maina.ofcmembers_name),'",','"ofcmember_type":"',IF(ISNULL(maina.ofcmember_type),'-',maina.ofcmember_type),'",','"city_id":"',IF(ISNULL(maina.city_id),'-',maina.city_id),'",','"ofcmembers_emailid":"',IF(ISNULL(maina.ofcmembers_emailid),'-',maina.ofcmembers_emailid),'",','"ofcmembers_password":"',IF(ISNULL(maina.ofcmembers_password),'-',maina.ofcmembers_password),'",','"ofcmembers_address1":"',IF(ISNULL(maina.ofcmembers_address1),'-',maina.ofcmembers_address1),'",','"ofcmembers_address2":"',IF(ISNULL(maina.ofcmembers_address2),'-',maina.ofcmembers_address2),'",','"ofcmembers_pincode":"',IF(ISNULL(maina.ofcmembers_pincode),'-',maina.ofcmembers_pincode),'",','"ofcmembers_contactnos":"',IF(ISNULL(maina.ofcmembers_contactnos),'-',maina.ofcmembers_contactnos),'",','"ofcmembers_availability":"',IF(ISNULL(maina.ofcmembers_availability),'-',maina.ofcmembers_availability),'",','"ofcmembers_displayname":"',IF(ISNULL(maina.ofcmembers_displayname),'-',maina.ofcmembers_displayname),'",','"ofcmembers_description":"',IF(ISNULL(maina.ofcmembers_description),'-',maina.ofcmembers_description),'",','"ofcmembers_selfrating":"',IF(ISNULL(maina.ofcmembers_selfrating),'-',maina.ofcmembers_selfrating),'",','"ofcmembers_experiencelevel":"',IF(ISNULL(maina.ofcmembers_experiencelevel),'-',maina.ofcmembers_experiencelevel),'",','"ofcmembers_gender":"',IF(ISNULL(maina.ofcmembers_gender),'-',maina.ofcmembers_gender),'",','"ofcmembers_dob":"',IF(ISNULL(maina.ofcmembers_dob),'-',UNIX_TIMESTAMP(maina.ofcmembers_dob)*1000),'",','"ofcmembers_nosofteammembers":"',IF(ISNULL(maina.ofcmembers_nosofteammembers),'-',maina.ofcmembers_nosofteammembers),'",','"city_name":"',IF(ISNULL(maina.city_name),'-',maina.city_name),'",','"country_name":"',IF(ISNULL(maina.country_name),'-',maina.country_name),'",','"state_name":"',IF(ISNULL(maina.state_name),'-',maina.state_name),'",','"ofcsubmitproposal_id":"',IF(ISNULL(maina.ofcsubmitproposal_id),'-',maina.ofcsubmitproposal_id),'",','"ofcprojectpost_id_fksubmitproposal":"',IF(ISNULL(maina.ofcprojectpost_id_fksubmitproposal),'-',maina.ofcprojectpost_id_fksubmitproposal),'",','"ofcmembers_id_fksubmitproposal":"',IF(ISNULL(maina.ofcmembers_id_fksubmitproposal),'-',maina.ofcmembers_id_fksubmitproposal),'",','"ofcsubmitproposal_coverletter":"',IF(ISNULL(maina.ofcsubmitproposal_coverletter),'-',maina.ofcsubmitproposal_coverletter),'",','"ofcsubmitproposal_budget":"',IF(ISNULL(maina.ofcsubmitproposal_budget),'-',maina.ofcsubmitproposal_budget),'",','"ofcsubmitproposal_negotiable":"',IF(ISNULL(maina.ofcsubmitproposal_negotiable),'-',maina.ofcsubmitproposal_negotiable),'",','"ofcsubmitproposal_commissionpercentage":"',IF(ISNULL(maina.ofcsubmitproposal_commissionpercentage),'-',maina.ofcsubmitproposal_commissionpercentage),'",','"ofcsubmitproposal_commissionamount":"',IF(ISNULL(maina.ofcsubmitproposal_commissionamount),'-',maina.ofcsubmitproposal_commissionamount),'",','"ofcsubmitproposal_finalamount":"',IF(ISNULL(maina.ofcsubmitproposal_finalamount),'-',maina.ofcsubmitproposal_finalamount),'",','"ofcsubmitproposal_timeframe":"',IF(ISNULL(maina.ofcsubmitproposal_timeframe),'-',maina.ofcsubmitproposal_timeframe),'",','"ofcsubmitproposal_availability":"',IF(ISNULL(maina.ofcsubmitproposal_availability),'-',maina.ofcsubmitproposal_availability),'",','"ofcsubmitproposal_status":"',IF(ISNULL(maina.ofcsubmitproposal_status),'-',maina.ofcsubmitproposal_status),'",','"ofcsubmitproposal_remarks":"',IF(ISNULL(maina.ofcsubmitproposal_remarks),'-',maina.ofcsubmitproposal_remarks),'",','"ofcsubmitproposal_terms":"',IF(ISNULL(maina.ofcsubmitproposal_terms),'-',maina.ofcsubmitproposal_terms),'",','"ofcsubmitproposal_estimatestartdate":"',IF(ISNULL(maina.ofcsubmitproposal_estimatestartdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_estimatestartdate)*1000),'",','"ofcsubmitproposal_startdate":"',IF(ISNULL(maina.ofcsubmitproposal_startdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_startdate)*1000),'",','"ofcsubmitproposal_enddate":"',IF(ISNULL(maina.ofcsubmitproposal_enddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_enddate)*1000),'",','"ofcsubmitproposal_estimatedays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedays),'-',maina.ofcsubmitproposal_estimatedays),'",','"ofcsubmitproposal_estimatedhoursindays":"',IF(ISNULL(maina.ofcsubmitproposal_estimatedhoursindays),'-',maina.ofcsubmitproposal_estimatedhoursindays),'",','"ofcsubmitproposal_reportabusebyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyemployeer),'-',maina.ofcsubmitproposal_reportabusebyemployeer),'",','"ofcsubmitproposal_reportabusebyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_reportabusebyfreelancer),'-',maina.ofcsubmitproposal_reportabusebyfreelancer),'",','"ofcsubmitproposal_proposalacceptdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalacceptdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalacceptdate)*1000),'",','"ofcsubmitproposal_proposalrejectdate":"',IF(ISNULL(maina.ofcsubmitproposal_proposalrejectdate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_proposalrejectdate)*1000),'",','"ofcsubmitproposal_completeddate":"',IF(ISNULL(maina.ofcsubmitproposal_completeddate),'-',UNIX_TIMESTAMP(maina.ofcsubmitproposal_completeddate)*1000),'",','"ofcsubmitproposal_iscompletedbyemployeer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyemployeer),'-',maina.ofcsubmitproposal_iscompletedbyemployeer),'",','"ofcsubmitproposal_iscompletedbyfreelancer":"',IF(ISNULL(maina.ofcsubmitproposal_iscompletedbyfreelancer),'-',maina.ofcsubmitproposal_iscompletedbyfreelancer),'",','"ofcsubmitproposal_workstatus":"',IF(ISNULL(maina.ofcsubmitproposal_workstatus),'-',maina.ofcsubmitproposal_workstatus),'",','"createdate":"',IF(ISNULL(maina.createdate),'-',UNIX_TIMESTAMP(maina.createdate)*1000),'",','"modifieddate":"',IF(ISNULL(maina.modifieddate),'-',UNIX_TIMESTAMP(maina.modifieddate)*1000),'",','"status":"',IF(ISNULL(maina.status),'-',maina.status),'",','"questansarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcsubmitproposalquest_id',sub0.ofcsubmitproposalquest_id,'ofcsubmitproposal_id_ofcsubmitproposalquest',sub0.ofcsubmitproposal_id_ofcsubmitproposalquest,'ofcsubmitproposalquest_question',sub0.ofcsubmitproposalquest_question,'ofcsubmitproposalquest_answer',sub0.ofcsubmitproposalquest_answer)) ,'],')FROM vw_vwofcmember_city_state_country_submitproposal_details main0, tbl_ofcsubmitproposal_questionanswers sub0 WHERE main0.ofcsubmitproposal_id=sub0.ofcsubmitproposal_id_ofcsubmitproposalquest AND sub0.ofcsubmitproposalquest_id = sub0.ofcsubmitproposalquest_id)),'"skillsarr":',(SELECT CONCAT('[',GROUP_CONCAT( json_object('ofcmemberskill_id',sub1.ofcmemberskill_id,'skill_id',sub1.skill_id,'ofcmembers_id',sub1.ofcmembers_id,'createdate',UNIX_TIMESTAMP(sub1.createdate)*1000,'modifieddate',UNIX_TIMESTAMP(sub1.modifieddate)*1000,'status',sub1.status)) ,']}')FROM vw_vwofcmember_city_state_country_submitproposal_details main1, tbl_ofcmemberskill_details sub1 WHERE main1.ofcmembers_id_fksubmitproposal=sub1.ofcmembers_id AND sub1.ofcmemberskill_id = sub1.ofcmemberskill_id))FROM vw_vwofcmember_city_state_country_submitproposal_details maina WHERE maina.ofcsubmitproposal_id=maina.ofcsubmitproposal_id AND  maina.ofcprojectpost_id_fksubmitproposal=ofcprojectpostid ),']'));
...
/* Procedure structure for procedure `proc_sot_blacklist_complaints` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_sot_blacklist_complaints` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_sot_blacklist_complaints`(
    IN membersessionid VARCHAR(100),
    IN inparam json, -- tbl_sotblacklist_complaints
    IN fileuploadjson json, 
    OUT outparam json,
    out outfileupload json
...
BEGIN
    ...
    IF @truesession THEN
        -- SET istrue=TRUE;
         ...
         IF @memid IS NULL AND @memid = '' THEN
            ...
            LEAVE label1;
         ELSE
            CALL proc_runningid('SOTC',@p);
             INSERT INTO tbl_sotblacklist_complaints
             (sotblacklist_id,sotblacklist_companyname,sotblacklist_companydescription,sotblacklist_companyaddress,
             ofcmembers_id_sotblacklist,city_id_sotblacklist,sotblacklist_reasontitle,sotblacklist_reasondescription,sotblacklist_myphonenos,
             sotblacklist_myemailid,sotblacklist_isverified,sotblacklist_isblacklisted,sotblacklist_rating,createdate,status,sotindustrytype_id_sotblacklist)
             VALUES(@p,
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_companyname')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_companydescription')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_companyaddress')),
             @memid,
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].city_id_sotblacklist')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_reasontitle')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_reasondescription')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].ofcsubmitproposal_commissionamount')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_myphonenos')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_myemailid')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_isverified')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_isblacklisted')),
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotblacklist_rating')),
             NOW(),'active',
             JSON_UNQUOTE(JSON_EXTRACT(inparam , '$[0].sotindustrytype_id_sotblacklist')));
             
             
            CALL proc_uploadfile_master_createjson('tbl_sotblacklist_complaints',@p,fileuploadjson,@outparam2);
    ...
    END IF;
     ...
     COMMIT;
     SET Isuccess = TRUE;
     SET Error = 'Feedback/Complaint Posted Successfully';
     SET outparam =  (SELECT JSON_OBJECT('Isuccess', Isuccess,
         'Error', Error,
         'Validation', Validation,
       'Controlid', Controlid));
...
/* Procedure structure for procedure `proc_sot_blacklist_complaints_selectwithoutlogin` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_sot_blacklist_complaints_selectwithoutlogin` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_sot_blacklist_complaints_selectwithoutlogin`(out outparam json)
BEGIN
	set outparam=(SELECT CONCAT('[',GROUP_CONCAT( json_object('sotblacklist_id',sotblacklist_id,'sotblacklist_companyname',sotblacklist_companyname,'sotblacklist_companydescription',sotblacklist_companydescription)),']') FROM tbl_sotblacklist_complaints);
    END */$$
DELIMITER ;

/* Procedure structure for procedure `proc_sot_get_blacklist_complaints_bysotblacklist_id` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_sot_get_blacklist_complaints_bysotblacklist_id` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_sot_get_blacklist_complaints_bysotblacklist_id`(
    IN membersessionid VARCHAR(100),   
    IN sotblacklistid VARCHAR(100),
    OUT outparam json  
    )
label1:
BEGIN
	...
	IF @truesession THEN
		-- SET istrue=TRUE;
		 ...
		 ELSE
			...
			SET outparam=(SELECT json_object('sotblacklist_id',a.sotblacklist_id,'sotblacklist_companyname',a.sotblacklist_companyname,
 'sotblacklist_companydescription',a.sotblacklist_companydescription,'sotblacklist_companyaddress',a.sotblacklist_companyaddress,
 'ofcmembers_id_sotblacklist',a.ofcmembers_id_sotblacklist,
 'city_id_sotblacklist',a.city_id_sotblacklist,
 'sotblacklist_reasontitle',a.sotblacklist_reasontitle,
 'sotblacklist_reasondescription',a.sotblacklist_reasondescription,
 'sotblacklist_myphonenos',a.sotblacklist_myphonenos,
 'sotblacklist_myemailid',a.sotblacklist_myemailid,
 'sotblacklist_isverified',a.sotblacklist_isverified,
 'sotblacklist_isblacklisted',a.sotblacklist_isblacklisted,
 'sotblacklist_rating',a.sotblacklist_rating,
 'sotindustrytype_name',b.sotindustrytype_name,
 'sotindustrytype_id_sotblacklist',a.sotindustrytype_id_sotblacklist,
 'city_name',c.city_name,
 'state_name',d.state_name,
 'country_name',e.country_name) FROM tbl_sotblacklist_complaints a,tbl_sotindustrytype_master b, tbl_city_master c,tbl_state_master d,tbl_country_master e 
 WHERE a.sotindustrytype_id_sotblacklist=b.sotindustrytype_id AND a.city_id_sotblacklist=c.city_id 
 AND c.state_id=d.state_id AND d.country_id = e.country_id and a.sotblacklist_id=sotblacklistid);
...
/* Procedure structure for procedure `proc_tbl_plan_master_drpjson` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_tbl_plan_master_drpjson` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_tbl_plan_master_drpjson`(OUT result json,OUT outparam json)
label1:
BEGIN
 DECLARE errcount INT;
DECLARE errno INT;
...
IF errcount = 0  THEN SELECT '1mapped insert succeeded, current DA is empty' AS op;
SET Error = 'mapped insert succeeded, current DA is empty' ;
ELSE GET CURRENT DIAGNOSTICS CONDITION 1 errno = MYSQL_ERRNO, msg = MESSAGE_TEXT;END IF ;GET STACKED DIAGNOSTICS CONDITION 1 errno = MYSQL_ERRNO, msg = MESSAGE_TEXT;SET Error = CONCAT("ERROR ", errno, " : ", msg);SET outparam =  (SELECT JSON_OBJECT('Isuccess', Isuccess, 'Error', Error,'Validation', Validation,'Controlid', Controlid));ROLLBACK;END;START TRANSACTION;SET Isuccess =FALSE;SET  Validation ='';SET Error ='';SET Controlid ='';CALL proc_common_drpjson('plan_id','plan_name','tbl_plan_master','',result);COMMIT;SET Isuccess = TRUE;END */$$
DELIMITER ;
...
/* Procedure structure for procedure `proc_tbl_sotindustrytype_master_drpjson` */

/*!50003 DROP PROCEDURE IF EXISTS  `proc_tbl_sotindustrytype_master_drpjson` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_tbl_sotindustrytype_master_drpjson`(OUT result json,OUT outparam json)
label1:
BEGIN
 DECLARE errcount INT;
DECLARE errno INT;
...
IF errcount = 0  THEN SELECT '1mapped insert succeeded, current DA is empty' AS op;
SET Error = 'mapped insert succeeded, current DA is empty' ;
ELSE GET CURRENT DIAGNOSTICS CONDITION 1 errno = MYSQL_ERRNO, msg = MESSAGE_TEXT;END IF ;GET STACKED DIAGNOSTICS CONDITION 1 errno = MYSQL_ERRNO, msg = MESSAGE_TEXT;SET Error = CONCAT("ERROR ", errno, " : ", msg);SET outparam =  (SELECT JSON_OBJECT('Isuccess', Isuccess, 'Error', Error,'Validation', Validation,'Controlid', Controlid));ROLLBACK;END;START TRANSACTION;SET Isuccess =FALSE;SET  Validation ='';SET Error ='';SET Controlid ='';CALL proc_common_drpjson('sotindustrytype_id','sotindustrytype_name','tbl_sotindustrytype_master','',result);COMMIT;SET Isuccess = TRUE;END */$$
DELIMITER ;
